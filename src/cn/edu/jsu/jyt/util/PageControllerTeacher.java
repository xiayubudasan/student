...
public class PageControllerTeacher {
	...
	{// 初始化代码块
		if(
			PageControllerTeacher.bigList==null) {
			PageControllerTeacher.bigList=TeacherDao.getSelectAll("select * from student");// 调用查询数据库的方法，返回所有的行
		}
		//获取总页数
	...
	public PageControllerTeacher() {}//无参构造方法

	public PageControllerTeacher(int curentPageIndex) {//构造方法设置当前页
