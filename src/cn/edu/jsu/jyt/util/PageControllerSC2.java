...
public class PageControllerSC2 {
	...
	{// 初始化代码块
		if(PageControllerSC2.bigList==null) {
			
			PageControllerSC2.bigList=ScoreDao.getSelectAll("select * from score");// 调用查询数据库的方法，返回所有的行
	...
	public PageControllerSC2() {}//无参构造方法

	public PageControllerSC2(int curentPageIndex) {//构造方法设置当前页
