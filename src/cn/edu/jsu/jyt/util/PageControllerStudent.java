...
public class PageControllerStudent {
	...
	{// 初始化代码块
		if(PageControllerStudent.bigList==null) {
			PageControllerStudent.bigList=StudentDao.getSelectAll("select * from student");// 调用查询数据库的方法，返回所有的行
		}
		//获取总页数
	...
	public PageControllerStudent() {}//无参构造方法

	public PageControllerStudent(int curentPageIndex) {//构造方法设置当前页
